...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="reCalculate",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11reCalculate11AppDelegate")
...
SWIFT_CLASS("_TtC11reCalculate8InfoCard")
@interface InfoCard : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11reCalculate13SceneDelegate")
...
SWIFT_CLASS("_TtC11reCalculate14ViewController")
@interface ViewController : UIViewController <UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified liquid;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified length;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified weight;
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified infoStack;
- (void)viewDidLoad;
/// This function will be called when the button named weight gets tapped.
/// warning:
///
/// \param sender <em>UIGestureRecognizer</em>
///
///
/// returns:
///
- (void)weightTap:(UIGestureRecognizer * _Nonnull)sender;
...
/// returns:
///
- (void)weightLong:(UIGestureRecognizer * _Nonnull)sender;
...
/// returns:
///
- (void)lengthTap:(UIGestureRecognizer * _Nonnull)sender;
...
/// returns:
///
- (void)lengthLong:(UIGestureRecognizer * _Nonnull)sender;
...
/// returns:
///
- (void)liquidTap:(UIGestureRecognizer * _Nonnull)sender;
...
/// returns:
///
- (void)liquidLong:(UIGestureRecognizer * _Nonnull)sender;
...
/// warning:
///
/// \param notification will catch any notification happening.
///
///
/// returns:
/// <em>nil</em>
